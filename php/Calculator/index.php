...
function showHelp()
{
    ...
    echo '> After a number is entered an operation (*, /, +, -, =) is selected, the value into the input register 
        is pushed onto a calculation stack and the input register is cleared, ready to accept the next number.' . PHP_EOL;
