...
function showHelp()
{
    ...
    echo '> Before any number you must write the operation (*, /, +, -, =) to process with the input, 
        the value into the input register is pushed onto a calculation stack and the input register is cleared, 
        ready to accept the next number.' . PHP_EOL;
    echo '> Selecting an operation executes any operations inside the calculation stack reducing the stack only 
        to the calculated value.' . PHP_EOL;
    echo PHP_EOL;
}
