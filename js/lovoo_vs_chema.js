...
function getByLang(n){return function(n){switch(user_lang){case LANG_ENGLISH:return NO==n?"not":"yes";case LANG_SPANISH:return NO==n?"no":"sí";case LANG_GERMAN:return NO==n?"nein":"ja";default:return"undefined"}}(n)}function pressTheCorrectButton(n,e){n&&(!only_verified||only_verified&&e.verified)?btn_yes.click(e):btn_no.click(e)}NO="not",YES="yes",LANG_ENGLISH="en",LANG_SPANISH="es",LANG_GERMAN="de";var user_lang=LANG_ENGLISH,from_where="berlin",only_verified=!0,each_ms=200,with_log=!0,limit=-1,no_in_user_lang=getByLang(NO),yes_in_user_lang=getByLang(YES),Person=function(n,e,t,s){this.name=n,this.age=e,this.city=t,this.verified=s},Btn=function(n){var e=$("span ."+(1==n?"yes":"no"));return this.persons=[],{click:function(n){e.click(),this.persons.push(n)},persons:this.persons}},btn_yes=new Btn(1),btn_no=new Btn(0),si=setInterval(function(){var n=$("div[ng-if='user'] div:nth-child(2) .h6"),e=n.find("div:nth-child(3) div").text().toLowerCase(),t=-1==e.indexOf(" "+no_in_user_lang+" "),s=n.find("div:nth-child(1)").first().text().toLowerCase().split(" ")[0],i=0==from_where.length?!0:-1!=s.indexOf(from_where.toLowerCase()),r=n.prev().text().split(", "),o=r[0],_=r[1],l=new Person(o,_,s,t);pressTheCorrectButton(i,l);var a=btn_yes.persons.length+btn_no.persons.length;with_log&&console.log(yes_in_user_lang+": "+btn_yes.persons.length+", "+no_in_user_lang+": "+btn_no.persons.length+", total: "+a),-1!=limit&&a>=limit&&clearInterval(si)},each_ms);
